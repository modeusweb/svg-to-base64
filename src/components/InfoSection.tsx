  ...
  return (
    <article className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
      ...
      <div className="text-gray-600 dark:text-gray-300 leading-relaxed text-sm space-y-4">
        <p>
          BaseVector is a free online SVG to base64 converter that transforms Scalable Vector Graphics
        ...
        <p>
          Simply drag and drop an SVG file into the upload area (or click to browse), and BaseVector
          instantly generates ready-to-paste code in your chosen format with a live
        ...
        <p>
          Try BaseVector now — no registration required, no file uploads to servers.
